<footer id="footer">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              ...
              <div class="social-links mt-3">
                <a href="https://mobile.twitter.com/GENELAB13" class=""><i class="bx bxl-twitter"></i></a>
                
                <a href="https://www.instagram.com/genelab13/" class=""><i class="bx bxl-instagram"></i></a>
                <!--
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>مختبر جين </span></strong>جميع الحقوق محفوظة
      </div>
      <div class="credits">
